...
import ListTapmenu from "../../../../Component/Main/list_menu_click";
import { useState } from "react";
import Pagination from "react-js-pagination";
import ButtonComponent from "@/Component/Main/Buttons/LoginRequiredButton";
    ...
    <P.goods_review id="review">
      ...
      <P.grade_Wrapper>
        ...
        <div>
          ...
          {/* 빈별 */}
          {props.inactiveStars}
          {!props.product?.grade || props.product?.grade === 0 ? "☆☆☆☆☆" : ""}
        </div>

        <p>총 {props.product.reviews?.length || "0"}건</p>
      </P.grade_Wrapper>
      ...
      <P.review_list_wrapper>
        ...
        <P.review_list>
          {props.product.review && props.product.review.length > 0 ? (
            props.product.review.map((review, key) => {
              return (
                <P.review key={review.id || index}>
                  {/* 별점 + 점수 */}
                  <P.review_grade_wrapper>
                    ...
                    <P.grade_number>{props.product.grade}</P.grade_number>
                  </P.review_grade_wrapper>
            ...
            <P.NoReviewWrapper>
              <P.NoReviewIcon />
              <p>아직 작성된 리뷰가 없어요.</p>
              <span>이 상품의 첫 번째 리뷰어가 되어보세요!</span>
