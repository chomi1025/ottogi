...
// 아이콘은 이미지가 있으면 Image 태그를 쓰고, 없으면 간단하게 배경으로 처리
export const NoReviewIcon = styled.div`
  width: 60px;
  height: 60px;
  background-image: url("https://cdn-icons-png.flaticon.com/512/5058/5058432.png"); // 예시 아이콘
  background-size: contain;
  background-repeat: no-repeat;
  opacity: 0.3; /* 너무 튀지 않게 살짝 투명도 */
`;
