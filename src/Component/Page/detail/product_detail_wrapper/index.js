...
export default function ProductDetailWrapper(props) {
  ...
  const onclickActive = (index) => () => {
    setActiveTab(index);
    const sectionIds = ["detail", "review", "info", "inquiry"];
            ...
            <P.tapMenu_list active={activeTab == 1} onClick={onclickActive(1)}>
              <Link href="#review">
                <P.tapmenu_button active={activeTab == 1}>
                  상품후기 <span>{props.product.reviews?.length || "0"}</span>
                </P.tapmenu_button>
              </Link>
            </P.tapMenu_list>
      ...
      <P.goods_detail_wrapper>
        ...
        <P.Main_wrapper>
          <P.main_contents_Wrapper id="detail">
            <div>
              <img
                src="https://ottogimall.diskn.com/%E2%98%85notice/notice_2_ottogimall.jpg"
                alt="A sample image"
              />
              ...
              <img
                layout="fill"
                src="https://ottogimall.diskn.com/%E2%98%85notice/delivery_roomtemperature_ottogimall.jpg"
                alt="안내사항"
              />
            </div>
